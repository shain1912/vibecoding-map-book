...
![그림 17.2 — 책상(메모리)과 서랍(localStorage)](images/ch17/ch17-f02.png){ width="760" }
...
![그림 17.4 — 직렬화 왕복 파이프라인](images/ch17/ch17-f04.png){ width="760" }
...
![그림 17.7 — 가져오기 성공 토스트](images/ch17/ch17-f07.jpg){ width="760" }
