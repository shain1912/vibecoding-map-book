...
![그림 13.1 — 기본 InfoWindow가 열린 모습](images/ch13/ch13-f01.jpg){ width="760" }
...
![그림 13.2 — yAnchor 값에 따라 달라지는 말풍선 위치](images/ch13/ch13-f02.png){ width="760" }
...
![그림 13.3 — 말풍선의 구조 분해도](images/ch13/ch13-f03.png){ width="760" }
...
![그림 13.4 — border 트릭으로 삼각형이 만들어지는 과정](images/ch13/ch13-f04.png){ width="760" }
...
![그림 13.5 — "하나만 열기" 상태 흐름도](images/ch13/ch13-f05.png){ width="760" }
...
![그림 13.6 — 완성된 커스텀 말풍선](images/ch13/ch13-f06.png){ width="520" }
