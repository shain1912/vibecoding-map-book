...
![그림 25.1 — npm run build 실행 결과와 dist 폴더](images/ch25/ch25-f01.png){ width="760" }
...
![그림 25.2 — base 설정이 필요한 이유: 하위 경로 문제](images/ch25/ch25-f02.png){ width="760" }
...
![그림 25.3 — 리포지토리 Secrets에 VITE_KAKAO_JS_KEY 등록](images/ch25/ch25-f03.jpg){ width="760" }
...
![그림 25.4 — Settings → Pages에서 Source를 GitHub Actions로](images/ch25/ch25-f04.jpg){ width="760" }
...
![그림 25.5 — Actions 탭: build → deploy 모두 초록 체크](images/ch25/ch25-f05.jpg){ width="760" }
...
![그림 25.6 — 카카오 개발자 콘솔 JavaScript SDK 도메인에 github.io 도메인 추가](images/ch25/ch25-f06.jpg){ width="760" }
...
![그림 25.7 — 배포 완료: github.io 주소에서 동작하는 내 지도](images/ch25/ch25-f07.jpg){ width="760" }
