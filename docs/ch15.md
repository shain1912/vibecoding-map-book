...
![그림 15.1 — 기본 SDK와 services 확장팩의 관계](images/ch15/ch15-f01.png){ width="760" }
...
![그림 15.2 — 사이드바 상단에 추가된 검색창](images/ch15/ch15-f02.png){ width="420" }
...
![그림 15.3 — 콘솔에서 keywordSearch 결과 확인](images/ch15/ch15-f03.png){ width="760" }
...
![그림 15.4 — "성수동 카페" 검색 결과 상위 7개](images/ch15/ch15-f04.jpg){ width="760" }
...
![그림 15.5 — 결과 클릭 후 레벨 3으로 확대 이동한 지도](images/ch15/ch15-f05.jpg){ width="760" }

![그림 15.6 — 결과가 없을 때의 토스트 알림](images/ch15/ch15-f06.jpg){ width="760" }
